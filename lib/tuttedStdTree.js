...
tuttedStdTree.function = function tuttedStdTreeFunction(name) {
  ...
  branch.getThrows = tuttedStdTreeAddGet(data.throws);
  branch.addThrow = tuttedStdTreeAddArrayAdd(data.throws);
...
tuttedStdTree.function.validate = function tuttedStdTreeFunctionValidate(branch) {
  ...
  tuttedStdTreeValidateMethod(branch, 'getThrows');
  tuttedStdTreeValidateMethod(branch, 'addThrow');
