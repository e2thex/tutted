...
describe("@module tuttedStdTree @is a module that helps to build a standard tutted tree", function() {
  describe("The @function tuttedStdTree.root() @constructs TuttedStdTreeRoot it @is used to create the base of the Std Code Tree", function() {
    describe("should @return a @type TuttedStdTreeRoot ", function() {
     var branch = tuttedStd.root();
      it("@is return object should have @property kind of type string which defaults to 'root' and is @immutable", function() {
  ...
  describe("The @function tuttedStdTree.root.validate() @validates TuttedStdTreeRoot and @is used to validate if something is a Tutted StdTreeRoot ", function() {
    it("should accept a @param obj of @type Object that @is The object to validate");
    it("should @return @type anything and should @is not throw an error if a correct root is passed", function() {
      (function() {
  ...
  describe("The @function tuttedStdTree.module() @is a method to generate a method branch", function() {
    it("should accept @param name of @type string which @is the name of the module", function() {
    ...
    describe("should @return a @type TuttedStdTreeModule", function() {
     var branch = tuttedStd.module();
      it("@is return object should have property kind of type string which is getOnly and defaults to 'module'", function() {
  ...
  describe("The @function tuttedStdTree.param() @constructs TuttedStdTreeFunction", function() {
    it("should @return a @type TuttedStdTreeParam",function() {
     (function() {
    ...
    it("should accept @param name of @type string which @is the name of the param and should be return by getName",function() {
     var branch = tuttedStd.param("this is the name");
     branch.getName().should.equal("this is the name");
    });
  });
  ...
  describe("The @function tuttedStdTree.retrun() @constructs TuttedStdTreeReturn", function() {
  ...
  describe.skip("The @function tuttedStdTree.property() @is a method to generate a property branch used for propertyeters and properties", function() {
